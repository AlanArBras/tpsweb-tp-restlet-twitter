...
public class UserResource extends ServerResource
{
    ...
    /**
     * Returns the user matching the is given in the URI, that has been deleted.
     * @return JSON representation of a user and an additionnal field "status" set as "deleted"
     */
    @Delete("json")
    public Representation delete()
    {
    	...
    	User user = ((InMemoryDatabase) backend_.getDatabase()).deleteUser(userId);
